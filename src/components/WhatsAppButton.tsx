...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 inline-flex items-center gap-3 rounded-full border border-[#25D366]/35 bg-[linear-gradient(135deg,#25D366,#128C7E)] px-3 py-3 text-white shadow-[0_18px_40px_rgba(18,140,126,0.32)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_22px_48px_rgba(18,140,126,0.42)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-base)]"
    >
      <span className="flex h-11 w-11 items-center justify-center rounded-full border border-white/20 bg-white/12 text-sm font-black uppercase tracking-[0.18em]">
        WA
      </span>
